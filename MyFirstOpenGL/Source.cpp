...
Model* LoadOBJModel(int IDProgram,const std::string& filePath, const char* texturefilePath) {
	...
	return new Model(IDProgram,texturefilePath, vertexs, textureCoordinates, vertexNormal);
}
...
void main() {
	...
	if (glewInit() == GLEW_OK) {
		...
		//Cargo Modelos
		Model* troll1; Model* troll2; Model * troll3;
		troll1 = LoadOBJModel(0, "Assets/Models/troll.obj", "Assets/Textures/troll.png");
		troll2 = LoadOBJModel(0, "Assets/Models/troll.obj", "Assets/Textures/troll.png");
		troll3 = LoadOBJModel(0, "Assets/Models/troll.obj", "Assets/Textures/troll.png");

		troll1->position=glm::vec3{-3.f,0.f,5.f};
		troll1->rotation=glm::vec3{0.f,-90.f,0.f};
		troll1->scale=glm::vec3{0.f,0.f,0.f};

		troll1->position = glm::vec3{ 0.f,0.f,5.f };
		troll1->rotation = glm::vec3{ 0.f,180.f,0.f };
		troll1->scale = glm::vec3{ 0.f,0.f,0.f };
		...
		models.push_back(troll1);models.push_back(troll2);models.push_back(troll3);
